...
export default function Shop({ session }) {
  ...
  // Индивы — только то, что Shop рисует САМ (аватар + bio + список групп).
  // Всё, что про пакеты/слоты/заявки — общий TeacherIndivDetail.
  ...
  const TeacherDetail = () => (
    <div>
      ...
      <TeacherIndivDetail teacherId={selectedTeacher} session={session} />
    </div>
  )
