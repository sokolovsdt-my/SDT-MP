...
export default function AvatarUpload({ userId, currentUrl, size = 52, onUpload }) {
  ...
  return (
    <label style={{ cursor: 'pointer', position: 'relative', flexShrink: 0 }}>
      ...
      <div style={{ width: size, height: size, borderRadius: '50%', overflow: 'hidden', background: '#BFD900', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: size * 0.35, fontWeight: 700, color: '#2a2a2a', position: 'relative' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: 0, transition: 'opacity 0.15s', fontSize: 18 }}
