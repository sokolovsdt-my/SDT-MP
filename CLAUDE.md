...
- **Трек 2 «Замкнуть бизнес-логику»:** ✅ S6/S7/S11/S12 закрыты (одной партией — RPC `cancel_booking`/`request_prize`/`register_push_token`/`update_my_profile` + два триггера-защитника на `profiles` и `bookings`). Осталось: S8, S9 (денежная справедливость), S10 (рефералка) + уведомления для индивов + онлайн-оплата.
