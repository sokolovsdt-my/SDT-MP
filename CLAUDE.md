...
- **Трек 3 «Производительность и UX»:** ✅ S13/S14 (Партия D — bundle splitting через React.lazy + manualChunks для vendor-кусков; useMemo для AdminFinance). ✅ AdminFinance loyalty с date-фильтром, TeacherPanel через RPC teacher_stats (Партия E). ✅ S20/S22/S23/S25 (Партия G — trgm-индекс, escapeIlike, lazy-images, SW notificationclick). Осталось: S24 (контраст + Inter).
